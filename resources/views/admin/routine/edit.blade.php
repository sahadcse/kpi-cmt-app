							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="shift" value="{{$routine->shift}}">
									</div>
									<div class="form-group">
										<label for="" class="bmd-label-floating">Semester</label>
										<input type="text" class="form-control" name="semester" value="{{$routine->semester}}">
									</div>
								...
								<a href="{{ route('routine.index')}}" class="btn btn-dark"> BACK</a>
